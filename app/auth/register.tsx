// Minimal Centered Register Screen with Polished Transitions
...
export default function RegisterScreen() {
    ...
    const handleRegister = async () => {
        ...
        setLoading(true);
        try {
            await login(email, password); // Mock registration
    ...
    const getHeaderContent = () => {
        switch (step) {
            ...
            case 'email-form': return { icon: 'user-plus', title: 'إنشاء حساب', subtitle: 'أكمل بياناتك للتسجيل' };
            default: return { icon: 'user-plus', title: 'حساب جديد', subtitle: 'انضم إلينا اليوم' };
        }
    };
                ...
                >
                    <View style={{ width: '100%', maxWidth: 400, alignItems: 'center' }}>
                        ...
                        <View className="items-center mb-12 h-40 justify-end">
                            <View className="w-20 h-20 bg-primary/10 rounded-full items-center justify-center mb-6 shadow-sm">
                            ...
                            {step === 'options' && (
                                ...
                                <View className="w-full gap-3">
                                    ...
                                    >
                                        ...
                                        <Text className="text-white font-cairo-bold text-base">تسجيل بالبريد</Text>
                                    </TouchableOpacity>
                        ...
                        {step !== 'otp' && (
                            <View className="mt-12">
                                <TouchableOpacity onPress={() => router.push('/auth/login')} className="py-2">
                                    <Text className="text-slate-500 font-cairo-medium">تسجيل الدخول</Text>
                                </TouchableOpacity>
                            </View>
                        )}
                    </View>
